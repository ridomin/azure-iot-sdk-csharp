...
$eventHubCompatibleName = az resource show -g $ResourceGroup --resource-type microsoft.devices/iothubs -n $ResourceGroup --query 'properties.outputs.eventHubCompatibleName.value' --output tsv
